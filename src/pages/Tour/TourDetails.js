...
// import { Calendar, MapPin, Users, ChevronLeft, ChevronUp, ChevronDown } from "lucide-react";
...
//   // agar propTour nahi mila to toursData se find karo
//   const selectedTour =
//     propTour ||
...
//     return <div className=" flex justify-center items-center h-[100vh] bg-black"><div className="text-center py-20 text-gray-500 font-extrabold text-4xl">Tour details not found 😕</div></div>;
//   }
...
//   // ✅ hooks always before any return or if condition
//   if (!selectedTour) return <div>Loading...</div>;
...
//   style={{ backgroundImage: `url(${details?.images && details.images.length > 0 ? details.images[0] : ""})` }}
// >
...
//             {/* Trip Overview */}
//             <div className="bg-white rounded-lg shadow-md p-6 mb-6">
//               <h2 className="text-xl font-bold text-gray-800 mb-4 border-l-4 border-orange-500 pl-3">Trip Overview</h2>
//               <p className="text-gray-600 leading-relaxed">{details.overview}</p>
//             </div>

//             {/* Trip Highlights */}
//             <div className="bg-white rounded-lg shadow-md p-6 mb-6">
//               <h2 className="text-xl font-bold text-gray-800 mb-4 border-l-4 border-orange-500 pl-3">Trip Highlights</h2>
...
//             {/* Inclusion & Exclusion */}
//             <div className="bg-white rounded-lg shadow-md p-6 mb-6">
//               <h2 className="text-xl font-bold text-gray-800 mb-4 border-l-4 border-orange-500 pl-3">Inclusions</h2>
...
//                 ))}
//               </div>
//               <h2 className="text-xl font-bold text-gray-800 mb-4 mt-6 border-l-4 border-orange-500 pl-3">Exclusions</h2>
//               <div className="grid grid-cols-2 gap-4">
...
//             {/* Itinerary */}
//             <div className="bg-white rounded-lg shadow-md p-6 mb-6">
//               <h2 className="text-xl font-bold text-gray-800 mb-4 border-l-4 border-orange-500 pl-3">Itinerary</h2>
...
//             {/* Upcoming Dates */}
//             <div className="bg-white rounded-lg shadow-md p-6 mb-6">
//               <h2 className="text-xl font-bold text-gray-800 mb-4 border-l-4 border-orange-500 pl-3">Upcoming Dates</h2>
...
//               <h3 className="text-lg font-bold text-gray-800 mb-4 border-l-4 border-orange-500 pl-3">For Enquiry</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {/* <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-800 mb-4 mt-6 border-l-4 border-orange-500 pl-3">
                Exclusions
              </h2>
              <div className="grid grid-cols-2 gap-4">
          ...
          <div key={idx} className="flex items-center text-gray-700">
            ...
            {/* <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="border-b pb-4 mb-4">
                ...
                {expandedPolicy === "refund" && Array.isArray(details.refundPolicy) && (
                  <ul className="mt-4 space-y-2 pl-4">
                    {details.refundPolicy.map((policy, idx) => (
                      <li
                        key={idx}
              ...
              <div className="border-b pb-4 mb-4">
                ...
                {expandedPolicy === "cancellation" && Array.isArray(details.cancellationPolicy) && (
                  <ul className="mt-4 space-y-2 pl-4">
                    {details.cancellationPolicy.map((policy, idx) => (
                      <li
                        key={idx}
              ...
              <div>
                ...
                {expandedPolicy === "payment" && Array.isArray(details.paymentTerms) && (
                  <ul className="mt-4 space-y-2 pl-4">
                    {details.paymentTerms.map((term, idx) => (
                      <li
                        key={idx}
